 ...
 * Author: Joe Goode
 *
 * This class tests the Product class by creating product
 * objects, comparing them, printing their details using
 * overloaded methods, tracking how many were created, and
 * calculating tax using the class constant.
 *********************************************************/
